...
<div class="box">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <?php if(permissionChecker('mailandsms_view') || permissionChecker('mailandsms_delete')) { ?>
    ...
    <td data-title="<?=$this->lang->line('action')?>">
        <?php echo btn_view('mailandsms/view/'.$mailandsms->mailandsmsID, $this->lang->line('view')) ?>
         ...
         <?php echo btn_delete('mailandsms/delete/'.$mailandsms->mailandsmsID, $this->lang->line('delete')) ?>
    </td>
                                    <?php } ?>
